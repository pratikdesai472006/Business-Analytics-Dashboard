  ...
  return (
    <DashboardLayout>
      <PageHeader
        ...
        title="Your profile"
        description="Manage your personal details and workspace security."
      />
      <div className="grid gap-5 xl:grid-cols-3">
        <section className="surface p-6 xl:col-span-2">
          <h3 className="font-bold">Personal information</h3>
          <div className="mt-6 flex items-center gap-4">
            <div className="grid place-items-center w-16 h-16 rounded-full bg-blue-600 text-lg font-bold text-white">
              {initials}
            </div>
            <div>
              <button className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm font-semibold">
                <Camera size={15} /> Change avatar
              </button>
          ...
          <form
            ...
            className="grid gap-4 mt-7 sm:grid-cols-2"
          >
        ...
        <aside className="surface p-6">
          ...
          <div className="mt-5 space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">July 2026</p>
            </div>
          </div>
        </aside>
      </div>
      <section className="surface mt-5 p-6">
        ...
        <div className="grid gap-4 mt-5 md:grid-cols-2">
          <div className="rounded-xl border border-slate-200 p-4">
            ...
            <p className="mt-3 text-sm font-semibold">Password protection</p>
            <p className="mt-1 text-xs text-slate-500">
          ...
          <div className="rounded-xl border border-slate-200 p-4">
            ...
            <p className="mt-3 text-sm font-semibold">Active session</p>
            <p className="mt-1 text-xs text-slate-500">
